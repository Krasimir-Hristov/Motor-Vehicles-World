...
export default function Listing() {
  ...
  return (
    <main>
      ...
      <div className="flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg bg-white 
      lg:space-x-5 mt-20">
        <div className="w-full h-full lg-h-[400px]">
          ...
          <div className="flex justify-start items-center space-x-4 w-[75%]">
            ...
            {listing.discount && (
                <p className="text-white  w-full max-w-[200px] bg-green-800 p-1 
                rounded-md text-center font-semibold shadow-md">
                    $ {Number(listing.regularPrice) - Number(listing.discountedPrice)} Discount </p>
            )} 
          </div>
          <p className="text-black mt-3 mb-3"><span
          className="font-bold">
            Description: </span>
          {listing.description}
          </p>
